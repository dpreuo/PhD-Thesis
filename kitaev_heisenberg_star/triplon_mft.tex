...
\begin{figure}[t]
    ...
    \caption[Transformation from the spin-half Star lattice model to a kagome triplon system.]{ 
...
\begin{figure}
    ...
    \caption[Triplon mean field results -- band structure, Chern numbers and edge modes.]{\textbf{(a-c)} Triplon excitation band structure, with the degeneracy of each energy indicated by line colour --  a legend is provided at the top of panel a. 
