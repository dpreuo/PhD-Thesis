...
\begin{itemize}
    ...
    \item \textit{Presses button under desk}, `Security, get this man out of here'
    \item `This is completely pointless, we already know how to do this using the Streda formula' \cite{yazdani_private, streda_theory_1982}
\end{itemize}
