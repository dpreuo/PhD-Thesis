...
\begin{figure}[t]
    ...
    \caption[Colouring an arbitrary lattice via two paths.] {Two distinct paths from $f_0$ to $f_j$. The combination of both paths forms a closed loop, where the value of $\mathfrak{f_j}$ is uniquely determined provided that $\bigoplus \mathfrak e$ around this loop vanishes.}
    \label{fig:two_paths}
\end{figure}%
\begin{align}
